...
A fase corrente é de **QA/QC, manutenção e refinamento da experiência de descoberta**. Não há expansão automática do corpus neste pacote.
...
**CONSOLIDADO.** Produto é o card canônico. Onde/Quando/Escala/Acesso permanecem visíveis. O lote inicial passa a 18 produtos e a grade usa 3 colunas em desktop, 2 em tablet/desktop estreito e 1 em smartphone.
