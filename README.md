...
Este repositório mantém a **Vitrine Ciência** como produto público estático e independentemente publicável.

O **Simbiotrama** é uma frente de trabalho diferente e possui repositório próprio: https://github.com/Ian-loc/simbiotrama

A Vitrine não depende de PostgreSQL/PostGIS, schemas, pipelines curatoriais ou CI do Simbiotrama para permanecer online. Durante a migração, materiais históricos do Simbiotrama podem continuar presentes em branches e no histórico Git deste repositório, mas não fazem parte do artefato publicado pela Vitrine.
